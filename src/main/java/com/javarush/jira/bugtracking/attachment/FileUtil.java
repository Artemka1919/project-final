...
public class FileUtil {
    ...
    public static void upload(MultipartFile multipartFile, String directoryPath, String fileName) {
        ...
        // Валидация имени файла (предотвращение атак path traversal)
        if (fileName.contains("..") || Paths.get(fileName).normalize().startsWith("..")) {
        ...
        try {
            ...
            throw new RuntimeException("Failed to upload file: " + multipartFile.getOriginalFilename(), ex);
        }
    }
